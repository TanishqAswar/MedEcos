              ...
              : _history.isEmpty
                  ? Center(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Icon(Icons.history, size: 64, color: Colors.blueGrey.withOpacity(0.4)),
                            ...
                            const Text(
                              'Your doses will appear here as you mark your medicines taken each day.',
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final date = DateTime.tryParse(log['takenTime']?.toString() ?? '') ?? DateTime.now();
                        final status = log['status']?.toString() ?? 'TAKEN';
                        final medName = log['medicineName']?.toString() ?? 'Medicine';
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            title: Text(medName, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
